  ...
  return (
    <section className="text-center my-32 mx-4 sm:mx-8 md:mx-16 lg:mx-24">
      ...
      <div className="flex justify-center space-x-6">
        <Link
          href="/constructor"
          className="bg-black text-white dark:bg-white dark:text-black px-5 py-2 rounded-md text-base font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition"
          >
          Get Started
        </Link>
      </div>
